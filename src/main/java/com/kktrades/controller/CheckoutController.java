...
import com.kktrades.service.PaymentService;
import com.kktrades.service.ShippingAddressService;
...
import com.kktrades.utility.MailConstructor;
import com.kktrades.utility.USConstants;
...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId, 
		...
		if (cartId != user.getShoppingCart().getId() || user.getShoppingCart().getCartItemList().isEmpty()) {
